...
/**
 * Main application class for DocumentVault.
 * Your Personal Document Security System - Offline-First Document Management.
 * This class initializes the JavaFX application and loads the main view.
 */
public class DocumentVaultApp extends Application {

    private static final String APP_TITLE = BrandConstants.APP_TITLE;
